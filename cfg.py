...
def parse_args():
    ...
    # hyperparameters specific to CCGAN
    parser.add_argument('--kernel_sigma', type=float, default=None,
                        help='standard deviation of gaussian noise in generating vicinal conditions. If None, then use rule-of-thumb formula to compute the sigma.')
    parser.add_argument('--kappa', type=float, default=None,
                        help='range of generated vicinal conditions from which fake conditions will be selected. If None, will be set equal to kernel_sigma.')
